...
public class RPCInvokeService {
	...
	public interface Iface {
		...
		public Msg invoke(String serviceName, String methodName, Msg msg)
				throws InvalidRequestException, TimedOutException, org.apache.thrift.TException;

	}

	public interface AsyncIface {

		public void invoke(String serviceName, String methodName, Msg msg,
	...
	public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
		...
		public void invoke(String serviceName, String methodName, Msg msg,
				org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
			checkReady();
			invoke_call method_call = new invoke_call(serviceName, methodName, msg, resultHandler, this,
		...
		public static class invoke_call extends org.apache.thrift.async.TAsyncMethodCall {
			...
			public invoke_call(String serviceName, String methodName, Msg msg,
	...
	public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
		...
		public static class invoke<I extends AsyncIface>
				extends org.apache.thrift.AsyncProcessFunction<I, invoke_args, Msg> {
			public invoke() {
				super("invoke");
			}
			...
			public void start(I iface, invoke_args args, org.apache.thrift.async.AsyncMethodCallback<Msg> resultHandler)
					throws TException {
	...
	public static class invoke_args implements org.apache.thrift.TBase<invoke_args, invoke_args._Fields>,
			java.io.Serializable, Cloneable, Comparable<invoke_args> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"invoke_args");

		private static final org.apache.thrift.protocol.TField SERVICE_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"serviceName", org.apache.thrift.protocol.TType.STRING, (short) 1);
		private static final org.apache.thrift.protocol.TField METHOD_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"methodName", org.apache.thrift.protocol.TType.STRING, (short) 2);
		private static final org.apache.thrift.protocol.TField MSG_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"msg", org.apache.thrift.protocol.TType.STRUCT, (short) 3);
		...
		public enum _Fields implements org.apache.thrift.TFieldIdEnum {
			SERVICE_NAME((short) 1, "serviceName"), METHOD_NAME((short) 2, "methodName"), MSG((short) 3, "msg");
		...
		static {
			Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
					_Fields.class);
			tmpMap.put(_Fields.SERVICE_NAME, new org.apache.thrift.meta_data.FieldMetaData("serviceName",
					org.apache.thrift.TFieldRequirementType.REQUIRED,
					new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
			tmpMap.put(_Fields.METHOD_NAME, new org.apache.thrift.meta_data.FieldMetaData("methodName",
					org.apache.thrift.TFieldRequirementType.REQUIRED,
					new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
		...
		public invoke_args(String serviceName, String methodName, Msg msg) {
			this();
			this.serviceName = serviceName;
			this.methodName = methodName;
			this.msg = msg;
		...
		/**
		 * Returns true if field serviceName is set (has been assigned a value)
		 * and false otherwise
		 */
		...
		/**
		 * Returns true if field methodName is set (has been assigned a value)
		 * and false otherwise
		 */
		...
		public void validate() throws org.apache.thrift.TException {
			...
			if (serviceName == null) {
				throw new org.apache.thrift.protocol.TProtocolException(
						"Required field 'serviceName' was not present! Struct: " + toString());
			}
			if (methodName == null) {
				throw new org.apache.thrift.protocol.TProtocolException(
			...
			if (msg == null) {
				throw new org.apache.thrift.protocol.TProtocolException(
						"Required field 'msg' was not present! Struct: " + toString());
			}
	...
	public static class invoke_result implements org.apache.thrift.TBase<invoke_result, invoke_result._Fields>,
		...
		private static final org.apache.thrift.protocol.TField INVALID_REQ_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"invalidReq", org.apache.thrift.protocol.TType.STRUCT, (short) 1);
		private static final org.apache.thrift.protocol.TField TIME_OUT_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"timeOut", org.apache.thrift.protocol.TType.STRUCT, (short) 2);
		 ...
		 */
		public enum _Fields implements org.apache.thrift.TFieldIdEnum {
			SUCCESS((short) 0, "success"), INVALID_REQ((short) 1, "invalidReq"), TIME_OUT((short) 2, "timeOut");
		...
		static {
			...
			tmpMap.put(_Fields.SUCCESS,
					new org.apache.thrift.meta_data.FieldMetaData("success",
							...
							new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT,
									Msg.class)));
			tmpMap.put(_Fields.INVALID_REQ, new org.apache.thrift.meta_data.FieldMetaData("invalidReq",
					org.apache.thrift.TFieldRequirementType.DEFAULT,
					new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
			tmpMap.put(_Fields.TIME_OUT, new org.apache.thrift.meta_data.FieldMetaData("timeOut",
					org.apache.thrift.TFieldRequirementType.DEFAULT,
					new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
			metaDataMap = Collections.unmodifiableMap(tmpMap);
		...
		public invoke_result(Msg success, InvalidRequestException invalidReq, TimedOutException timeOut) {
			this();
		...
		/**
		 * Returns true if field invalidReq is set (has been assigned a value)
		 * and false otherwise
		 */
		...
		/**
		 * Returns true if field timeOut is set (has been assigned a value) and
		 * false otherwise
		 */
